...
class cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_REQUEST : public BaseClass
{
    public:
        cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_REQUEST();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_REQUEST);
        }
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
...
class cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE : public BaseClass
{
    public:
        cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE(uint8_t* buff, size_t buff_len, bool parse = false);
        explicit cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
        ~cACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE);
        }
        uint8_t& success();
        void class_swap() override;
        bool finalize() override;
